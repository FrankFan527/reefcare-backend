...
#
# get_case_ownership_and_status was dropped when this file was merged; use
# get_report_owner above instead, which returns the same claimed_by_user_id
# and status_code with fewer joins.
# ---------------------------------------------------------------------------
